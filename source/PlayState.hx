...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Forgotten Skill', 0.06, 'X'], //Imagine playing so bad that you get 0% to 5%
		['Never Play Again', 0.2, 'F-'], //From 6% to 19%
		['What Are You Doing', 0.4, 'F'], //From 20% to 39%
		['Get Out Of This Game', 0.5, 'D'], //From 40% to 49%
		['What The Hell?', 0.6, 'C'], //From 50% to 59%
		['Restart Immediately', 0.69, 'B'], //From 60% to 68%
		['Nice', 0.7, '69'], //69%
		['Not Bad I Guess', 0.8, 'A'], //From 70% to 79%
		['Amazing!', 0.9, 'S'], //From 80% to 89%
		['Lunatic!!', 0.99, 'SS'], //From 90% to 99% //Its actually possible hahaha, i can set this to 0.99 so it seperates from SS+
		['Crazy!!!', 1, 'SS+'] //The value on this one isn't used actually, since Perfect is always "1"
	];
